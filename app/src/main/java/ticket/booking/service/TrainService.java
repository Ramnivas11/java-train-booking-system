...
public class TrainService {
    ...
    private boolean validTrain(Train train, String source, String destination) {
        ...
        List<String> lowercaseStationOrder = stationOrder.stream().map(String::toLowerCase).collect(Collectors.toList());

        int sourceIndex = lowercaseStationOrder.indexOf(source.toLowerCase());
        int destinationIndex = lowercaseStationOrder.indexOf(destination.toLowerCase());
